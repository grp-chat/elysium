...
class GridSystem {
    constructor() {
        ...
        this.playersArr = [
            this.p1 = new Player({x: 27, y: 18, lable: 2, id: this.extraArr[0], area: "area3", color: "grey"}),

            this.p2 = new Player({x: 13, y: 8, lable: 3, id: this.extraArr[1], area: "area1", color: "springgreen"}),
            this.p3 = new Player({x: 13, y: 9, lable: 4, id: this.extraArr[2], area: "area1", color: "orange"}),
            this.p4 = new Player({x: 13, y: 10, lable: 5, id: this.extraArr[3], area: "area1", color: "lightblue"}),
            this.p5 = new Player({x: 13, y: 11, lable: 6, id: this.extraArr[4], area: "area1", color: "lightyellow"}),
            this.p6 = new Player({x: 13, y: 12, lable: 7, id: this.extraArr[5], area: "area1", color: "deepskyblue"}),
